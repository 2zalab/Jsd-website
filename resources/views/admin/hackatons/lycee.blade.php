<div class="p-6">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Participants Hackathon — Lycée</h1>
        <a href="/generate-pdf-lycee" target="_blank"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table id="hackathonTable" class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($hackathonsLycee as $hackathon)
        ...
        <div class="px-5 py-4 bg-gray-50 border-t flex items-center justify-between text-sm text-gray-600">
            <span>Affichage de <span id="startIndex">1</span> à <span id="endIndex">{{ count($hackathonsLycee) }}</span> sur <span id="totalEntries">{{ count($hackathonsLycee) }}</span> équipes</span>
...
(function() {
    ...
    // Sortable columns (not members column)
