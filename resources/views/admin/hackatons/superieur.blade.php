...
<head>
    ...
    <title>Participants Hackathon Senior</title>
...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 sm:px-8 max-w-6xl">
        <div class="py-0">
            <h1 class="text-3xl font-bold leading-tight text-gray-900 mb-4">Participants Hackathon Senior</h1>
            <div class="p-4">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table id="hackathonTable" class="min-w-full leading-normal">
                        ...
                        <tbody>
                            @foreach($hackathonsSuperieur as $hackathon)
                            <tr>
                ...
                <div class="px-5 py-5 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between">
                    <span class="text-xs xs:text-sm text-gray-900">
                        Affichage de <span id="startIndex">1</span> à <span id="endIndex">{{ count($hackathonsSuperieur) }}</span> sur <span id="totalEntries">{{ count($hackathonsSuperieur) }}</span> équipes
                    </span>
