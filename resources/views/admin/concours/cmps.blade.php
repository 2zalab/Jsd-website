...
<head>
    ...
    <title>Concours Meilleurs Programmeurs Supérieur (CMPS)</title>
    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-0">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-semibold leading-tight">Concours Meilleurs Programmeurs Supérieur (CMPS)</h2>
            ...
            <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                    <table id="cmpsTable" class="min-w-full leading-normal">
                    ...
                    <div class="px-5 py-5 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between">
                        <span class="text-xs xs:text-sm text-gray-900">
                            Affichage de <span id="startIndex">1</span> à <span id="endIndex">{{ count($cmps) }}</span> sur <span id="totalEntries">{{ count($cmps) }}</span> entrées
                        </span>
