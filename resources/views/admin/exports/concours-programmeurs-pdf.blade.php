...
<style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .header { border-bottom: 3px solid #f59e0b; padding-bottom: 12px; margin-bottom: 18px; }
    ...
    .doc-title { font-size: 15px; font-weight: 700; color: #d97706; }
    .doc-badge { background: #fef3c7; color: #92400e; font-size: 9px; font-weight: 700; padding: 3px 10px; border-radius: 999px; }
    ...
    .stat-num { font-size: 17px; font-weight: 800; color: #d97706; }
    ...
    tbody td:first-child { font-weight: 700; color: #d97706; text-align: center; }
...
<div class="header">
    ...
    <div class="header-meta">
        ...
        <div class="doc-badge">{{ count($participants) }} participant(s)</div>
    </div>
</div>
...
<div class="stats-bar">
    ...
    @php
        $lycee = collect($participants)->where('type_concours','CMPL')->count();
        $sup   = collect($participants)->where('type_concours','CMPS')->count();
        $etablissements = collect($participants)->pluck('etablissement')->unique()->count();
    @endphp
    @if($lycee > 0)
    <div class="stat-box">
...
<table>
    ...
    <tbody>
        ...
        @empty
        <tr class="empty-row"><td colspan="{{ count($colonnes) + 1 }}">Aucun participant inscrit.</td></tr>
        @endforelse
    </tbody>
</table>
...
<div class="footer">
    ...
    <div class="footer-right">
        {{ count($participants) }} participant(s) inscrit(s)<br>
